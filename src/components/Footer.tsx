...
const Footer = () => {
  const socialLinks = [
    {
      name: "Facebook",
      href: "https://www.facebook.com/manuela.macedo1",
      icon: (
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/tupper_bl_acores_manuelamacedo/",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex space-x-4 justify-center">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center text-gray-600 hover:bg-black hover:text-white transition-colors duration-200"
